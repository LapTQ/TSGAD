...
def gen_dataset(person_json_root, num_clips=None, kp18_format=True, ret_keys=False, ret_global_data=True,
    ...
    for person_dict_fn in tqdm(json_list):
        ...
        elif dataset =="corridor" or dataset=='Avenue' or dataset=='CPCC' or dataset=='CPCC_X_setup' or dataset=='CPCC0' or dataset=='CPCC1' or dataset=='CPCC2' or dataset=='CPCC3' or dataset=='CPCC4' or dataset=='CPCC5' or dataset=='CPCC6':
