...
def main():
    ...
    args.save_cache_data = eval(args.save_cache_data) if args.save_cache_data is not None else False
    args.use_cache_data = eval(args.use_cache_data) if args.use_cache_data is not None else False
    ...
    if args.use_cache_data:
        ...
        print("Dataset and loader loaded from cache {}!".format(args.cache_data_path))
    else:
        print("Loading dataset and loader...")
        dataset, loader = get_dataset_and_loader(
            args, trans_list=trans_list, only_test=args.task == "val", skip_testset=True,
        )
    if args.save_cache_data:
        ...
        print("Dataset and loader saved to cache {}!".format(args.cache_data_path))
    else:
        print("Dataset and loader not saved to cache.")
